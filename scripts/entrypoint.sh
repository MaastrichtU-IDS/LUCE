...
python /app/src/luce/manage.py loaddata /luce/src/luce/utils/fixtures/demo_users.json
...
# python /app/src/luce/manage.py loaddata /luce/src/luce/utils/fixtures/demo_all_v2.json

## OR Create users based on GanacheDB
## Create superuser (if no users in init JSON)
# echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('vagrant@luce.com','Vagrant','Luce','Maastricht University','vagrant')" | python /luce/src/luce/manage.py shell
# python /app/src/luce/manage.py loaddata /luce/src/luce/utils/fixtures/demo_all_v3.json
...
python /app/src/luce/manage.py runserver 0.0.0.0:8000 --noreload
